...
- 新增 GitHub Actions 自動部署（`.github/workflows/deploy.yml`）；`vite.config.ts` 加入 `base: '/sim-monitor-dashboard/'`，專案可透過 GitHub Pages 對外發布
...
### 2026-06-02
- 初始化 git repo，推送至 GitHub（Yode0419/sim-monitor-dashboard）
